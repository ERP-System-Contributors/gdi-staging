...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './fixed-asset-depreciation.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FIXEDASSETDEPRECIATION_LIST actions', async () => {
    ...
    it('dispatches SEARCH_FIXEDASSETDEPRECIATIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_FIXEDASSETDEPRECIATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_FIXEDASSETDEPRECIATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_FIXEDASSETDEPRECIATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_FIXEDASSETDEPRECIATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_FIXEDASSETDEPRECIATION actions', async () => {
      const expectedActions = [
        {
