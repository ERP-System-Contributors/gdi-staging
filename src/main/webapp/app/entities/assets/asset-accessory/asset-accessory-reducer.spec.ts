...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ASSETACCESSORY_LIST actions', async () => {
    ...
    it('dispatches SEARCH_ASSETACCESSORIES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_ASSETACCESSORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ASSETACCESSORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ASSETACCESSORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ASSETACCESSORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ASSETACCESSORY actions', async () => {
      const expectedActions = [
        {
