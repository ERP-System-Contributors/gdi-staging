...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './work-in-progress-registration.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_WORKINPROGRESSREGISTRATION_LIST actions', async () => {
    ...
    it('dispatches SEARCH_WORKINPROGRESSREGISTRATIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_WORKINPROGRESSREGISTRATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_WORKINPROGRESSREGISTRATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_WORKINPROGRESSREGISTRATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_WORKINPROGRESSREGISTRATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_WORKINPROGRESSREGISTRATION actions', async () => {
      const expectedActions = [
        {
