...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './depreciation-job-notice.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DEPRECIATIONJOBNOTICE_LIST actions', async () => {
    ...
    it('dispatches SEARCH_DEPRECIATIONJOBNOTICES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_DEPRECIATIONJOBNOTICE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_DEPRECIATIONJOBNOTICE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_DEPRECIATIONJOBNOTICE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_DEPRECIATIONJOBNOTICE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_DEPRECIATIONJOBNOTICE actions', async () => {
      const expectedActions = [
        {
