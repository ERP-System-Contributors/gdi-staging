...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './depreciation-method.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DEPRECIATIONMETHOD_LIST actions', async () => {
    ...
    it('dispatches SEARCH_DEPRECIATIONMETHODS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_DEPRECIATIONMETHOD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_DEPRECIATIONMETHOD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_DEPRECIATIONMETHOD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_DEPRECIATIONMETHOD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_DEPRECIATIONMETHOD actions', async () => {
      const expectedActions = [
        {
