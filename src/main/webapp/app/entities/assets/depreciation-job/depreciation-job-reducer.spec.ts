...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DEPRECIATIONJOB_LIST actions', async () => {
    ...
    it('dispatches SEARCH_DEPRECIATIONJOBS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_DEPRECIATIONJOB actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_DEPRECIATIONJOB actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_DEPRECIATIONJOB actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_DEPRECIATIONJOB actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_DEPRECIATIONJOB actions', async () => {
      const expectedActions = [
        {
