...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ASSETCATEGORY_LIST actions', async () => {
    ...
    it('dispatches SEARCH_ASSETCATEGORIES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_ASSETCATEGORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ASSETCATEGORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ASSETCATEGORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ASSETCATEGORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ASSETCATEGORY actions', async () => {
      const expectedActions = [
        {
