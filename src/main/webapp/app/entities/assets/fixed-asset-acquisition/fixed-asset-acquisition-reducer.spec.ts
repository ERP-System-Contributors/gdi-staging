...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './fixed-asset-acquisition.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FIXEDASSETACQUISITION_LIST actions', async () => {
    ...
    it('dispatches SEARCH_FIXEDASSETACQUISITIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_FIXEDASSETACQUISITION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_FIXEDASSETACQUISITION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_FIXEDASSETACQUISITION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_FIXEDASSETACQUISITION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_FIXEDASSETACQUISITION actions', async () => {
      const expectedActions = [
        {
