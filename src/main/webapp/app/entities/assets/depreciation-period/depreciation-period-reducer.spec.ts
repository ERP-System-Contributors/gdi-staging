...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './depreciation-period.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DEPRECIATIONPERIOD_LIST actions', async () => {
    ...
    it('dispatches SEARCH_DEPRECIATIONPERIODS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_DEPRECIATIONPERIOD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_DEPRECIATIONPERIOD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_DEPRECIATIONPERIOD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_DEPRECIATIONPERIOD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_DEPRECIATIONPERIOD actions', async () => {
      const expectedActions = [
        {
