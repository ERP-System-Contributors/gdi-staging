...
const apiSearchUrl = 'api/_search/asset-registrations';

// Actions

export const searchEntities = createAsyncThunk('assetRegistration/search_entity', async ({ query, page, size, sort }: IQueryParams) => {
