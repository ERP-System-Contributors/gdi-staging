...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './asset-registration.reducer';
import { EntityState } from 'app/shared/reducers/reducer.utils';
import { IAssetRegistration, defaultValue } from 'app/shared/model/assets/asset-registration.model';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ASSETREGISTRATION_LIST actions', async () => {
    ...
    it('dispatches SEARCH_ASSETREGISTRATIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_ASSETREGISTRATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ASSETREGISTRATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ASSETREGISTRATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ASSETREGISTRATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ASSETREGISTRATION actions', async () => {
      const expectedActions = [
        {
