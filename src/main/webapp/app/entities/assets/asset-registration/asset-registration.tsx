...
import { searchEntities, getEntities } from './asset-registration.reducer';
          ...
          <Table responsive>
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('capitalizationDate')}>
                  Capitalization Date <FontAwesomeIcon icon="sort" />
                </th>
                <th>
                ...
                <th>
                  Main Service Outlet <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
            <tbody>
              {assetRegistrationList.map((assetRegistration, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>{assetRegistration.modelNumber}</td>
                  <td>{assetRegistration.serialNumber}</td>
                  <td>{assetRegistration.remarks}</td>
                  <td>
                    {assetRegistration.capitalizationDate ? (
                      <TextFormat type="date" value={assetRegistration.capitalizationDate} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>
                  ...
                  <td>
                    {assetRegistration.mainServiceOutlet ? (
                      <Link to={`/service-outlet/${assetRegistration.mainServiceOutlet.id}`}>
