...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ASSETWARRANTY_LIST actions', async () => {
    ...
    it('dispatches SEARCH_ASSETWARRANTIES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_ASSETWARRANTY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ASSETWARRANTY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ASSETWARRANTY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ASSETWARRANTY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ASSETWARRANTY actions', async () => {
      const expectedActions = [
        {
