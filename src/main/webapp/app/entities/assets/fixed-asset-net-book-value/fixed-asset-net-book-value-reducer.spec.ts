...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './fixed-asset-net-book-value.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FIXEDASSETNETBOOKVALUE_LIST actions', async () => {
    ...
    it('dispatches SEARCH_FIXEDASSETNETBOOKVALUES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_FIXEDASSETNETBOOKVALUE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_FIXEDASSETNETBOOKVALUE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_FIXEDASSETNETBOOKVALUE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_FIXEDASSETNETBOOKVALUE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_FIXEDASSETNETBOOKVALUE actions', async () => {
      const expectedActions = [
        {
