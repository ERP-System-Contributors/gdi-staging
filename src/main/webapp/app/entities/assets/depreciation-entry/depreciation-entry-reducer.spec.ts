...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './depreciation-entry.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DEPRECIATIONENTRY_LIST actions', async () => {
    ...
    it('dispatches SEARCH_DEPRECIATIONENTRIES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_DEPRECIATIONENTRY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_DEPRECIATIONENTRY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_DEPRECIATIONENTRY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_DEPRECIATIONENTRY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_DEPRECIATIONENTRY actions', async () => {
      const expectedActions = [
        {
