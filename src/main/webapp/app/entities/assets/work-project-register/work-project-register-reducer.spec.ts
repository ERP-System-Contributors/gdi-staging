...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './work-project-register.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_WORKPROJECTREGISTER_LIST actions', async () => {
    ...
    it('dispatches SEARCH_WORKPROJECTREGISTERS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_WORKPROJECTREGISTER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_WORKPROJECTREGISTER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_WORKPROJECTREGISTER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_WORKPROJECTREGISTER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_WORKPROJECTREGISTER actions', async () => {
      const expectedActions = [
        {
