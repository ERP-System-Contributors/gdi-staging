...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './depreciation-batch-sequence.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DEPRECIATIONBATCHSEQUENCE_LIST actions', async () => {
    ...
    it('dispatches SEARCH_DEPRECIATIONBATCHSEQUENCES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_DEPRECIATIONBATCHSEQUENCE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_DEPRECIATIONBATCHSEQUENCE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_DEPRECIATIONBATCHSEQUENCE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_DEPRECIATIONBATCHSEQUENCE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_DEPRECIATIONBATCHSEQUENCE actions', async () => {
      const expectedActions = [
        {
