...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './work-in-progress-transfer.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_WORKINPROGRESSTRANSFER_LIST actions', async () => {
    ...
    it('dispatches SEARCH_WORKINPROGRESSTRANSFERS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_WORKINPROGRESSTRANSFER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_WORKINPROGRESSTRANSFER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_WORKINPROGRESSTRANSFER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_WORKINPROGRESSTRANSFER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_WORKINPROGRESSTRANSFER actions', async () => {
      const expectedActions = [
        {
