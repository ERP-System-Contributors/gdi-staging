...
const apiSearchUrl = 'api/_search/xlsx-report-requisitions';

// Actions

export const searchEntities = createAsyncThunk('xlsxReportRequisition/search_entity', async ({ query, page, size, sort }: IQueryParams) => {
