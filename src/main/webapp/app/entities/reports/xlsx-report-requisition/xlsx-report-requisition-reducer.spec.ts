...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './xlsx-report-requisition.reducer';
import { EntityState } from 'app/shared/reducers/reducer.utils';
import { IXlsxReportRequisition, defaultValue } from 'app/shared/model/reports/xlsx-report-requisition.model';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_XLSXREPORTREQUISITION_LIST actions', async () => {
    ...
    it('dispatches SEARCH_XLSXREPORTREQUISITIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_XLSXREPORTREQUISITION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_XLSXREPORTREQUISITION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_XLSXREPORTREQUISITION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_XLSXREPORTREQUISITION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_XLSXREPORTREQUISITION actions', async () => {
      const expectedActions = [
        {
