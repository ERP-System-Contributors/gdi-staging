...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_REPORTDESIGN_LIST actions', async () => {
    ...
    it('dispatches SEARCH_REPORTDESIGNS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_REPORTDESIGN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_REPORTDESIGN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_REPORTDESIGN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_REPORTDESIGN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_REPORTDESIGN actions', async () => {
      const expectedActions = [
        {
