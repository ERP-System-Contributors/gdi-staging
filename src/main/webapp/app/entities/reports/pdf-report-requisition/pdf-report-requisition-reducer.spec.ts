...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './pdf-report-requisition.reducer';
import { EntityState } from 'app/shared/reducers/reducer.utils';
import { IPdfReportRequisition, defaultValue } from 'app/shared/model/reports/pdf-report-requisition.model';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PDFREPORTREQUISITION_LIST actions', async () => {
    ...
    it('dispatches SEARCH_PDFREPORTREQUISITIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_PDFREPORTREQUISITION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PDFREPORTREQUISITION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PDFREPORTREQUISITION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PDFREPORTREQUISITION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PDFREPORTREQUISITION actions', async () => {
      const expectedActions = [
        {
