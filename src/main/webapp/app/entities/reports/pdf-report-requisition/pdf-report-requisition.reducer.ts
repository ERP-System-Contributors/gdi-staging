...
const apiSearchUrl = 'api/_search/pdf-report-requisitions';

// Actions

export const searchEntities = createAsyncThunk('pdfReportRequisition/search_entity', async ({ query, page, size, sort }: IQueryParams) => {
