...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './excel-report-export.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_EXCELREPORTEXPORT_LIST actions', async () => {
    ...
    it('dispatches SEARCH_EXCELREPORTEXPORTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_EXCELREPORTEXPORT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_EXCELREPORTEXPORT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_EXCELREPORTEXPORT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_EXCELREPORTEXPORT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_EXCELREPORTEXPORT actions', async () => {
      const expectedActions = [
        {
