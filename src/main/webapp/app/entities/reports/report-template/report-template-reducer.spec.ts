...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './report-template.reducer';
import { EntityState } from 'app/shared/reducers/reducer.utils';
import { IReportTemplate, defaultValue } from 'app/shared/model/reports/report-template.model';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_REPORTTEMPLATE_LIST actions', async () => {
    ...
    it('dispatches SEARCH_REPORTTEMPLATES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_REPORTTEMPLATE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_REPORTTEMPLATE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_REPORTTEMPLATE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_REPORTTEMPLATE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_REPORTTEMPLATE actions', async () => {
      const expectedActions = [
        {
