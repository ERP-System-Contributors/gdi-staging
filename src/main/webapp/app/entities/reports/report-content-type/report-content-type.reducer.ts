...
const apiSearchUrl = 'api/_search/report-content-types';

// Actions

export const searchEntities = createAsyncThunk('reportContentType/search_entity', async ({ query, page, size, sort }: IQueryParams) => {
