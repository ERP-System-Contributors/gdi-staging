...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './report-content-type.reducer';
import { EntityState } from 'app/shared/reducers/reducer.utils';
import { IReportContentType, defaultValue } from 'app/shared/model/reports/report-content-type.model';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_REPORTCONTENTTYPE_LIST actions', async () => {
    ...
    it('dispatches SEARCH_REPORTCONTENTTYPES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_REPORTCONTENTTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_REPORTCONTENTTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_REPORTCONTENTTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_REPORTCONTENTTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_REPORTCONTENTTYPE actions', async () => {
      const expectedActions = [
        {
