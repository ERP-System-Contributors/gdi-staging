...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './report-requisition.reducer';
import { EntityState } from 'app/shared/reducers/reducer.utils';
import { IReportRequisition, defaultValue } from 'app/shared/model/reports/report-requisition.model';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_REPORTREQUISITION_LIST actions', async () => {
    ...
    it('dispatches SEARCH_REPORTREQUISITIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_REPORTREQUISITION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_REPORTREQUISITION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_REPORTREQUISITION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_REPORTREQUISITION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_REPORTREQUISITION actions', async () => {
      const expectedActions = [
        {
