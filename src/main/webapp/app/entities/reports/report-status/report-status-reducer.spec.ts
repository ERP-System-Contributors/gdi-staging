...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_REPORTSTATUS_LIST actions', async () => {
    ...
    it('dispatches SEARCH_REPORTSTATUSES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_REPORTSTATUS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_REPORTSTATUS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_REPORTSTATUS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_REPORTSTATUS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_REPORTSTATUS actions', async () => {
      const expectedActions = [
        {
