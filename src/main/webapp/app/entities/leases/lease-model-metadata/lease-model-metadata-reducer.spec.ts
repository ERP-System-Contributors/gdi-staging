...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './lease-model-metadata.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LEASEMODELMETADATA_LIST actions', async () => {
    ...
    it('dispatches SEARCH_LEASEMODELMETADATA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_LEASEMODELMETADATA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_LEASEMODELMETADATA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_LEASEMODELMETADATA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_LEASEMODELMETADATA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_LEASEMODELMETADATA actions', async () => {
      const expectedActions = [
        {
