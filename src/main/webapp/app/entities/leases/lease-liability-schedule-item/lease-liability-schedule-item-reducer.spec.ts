...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './lease-liability-schedule-item.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LEASELIABILITYSCHEDULEITEM_LIST actions', async () => {
    ...
    it('dispatches SEARCH_LEASELIABILITYSCHEDULEITEMS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_LEASELIABILITYSCHEDULEITEM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_LEASELIABILITYSCHEDULEITEM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_LEASELIABILITYSCHEDULEITEM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_LEASELIABILITYSCHEDULEITEM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_LEASELIABILITYSCHEDULEITEM actions', async () => {
      const expectedActions = [
        {
