...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LEASECONTRACT_LIST actions', async () => {
    ...
    it('dispatches SEARCH_LEASECONTRACTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_LEASECONTRACT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_LEASECONTRACT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_LEASECONTRACT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_LEASECONTRACT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_LEASECONTRACT actions', async () => {
      const expectedActions = [
        {
