...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_INSTITUTIONCONTACTDETAILS_LIST actions', async () => {
    ...
    it('dispatches SEARCH_INSTITUTIONCONTACTDETAILS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_INSTITUTIONCONTACTDETAILS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_INSTITUTIONCONTACTDETAILS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_INSTITUTIONCONTACTDETAILS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_INSTITUTIONCONTACTDETAILS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_INSTITUTIONCONTACTDETAILS actions', async () => {
      const expectedActions = [
        {
