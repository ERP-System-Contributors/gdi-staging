...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_NATUREOFCUSTOMERCOMPLAINTS_LIST actions', async () => {
    ...
    it('dispatches SEARCH_NATUREOFCUSTOMERCOMPLAINTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_NATUREOFCUSTOMERCOMPLAINTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_NATUREOFCUSTOMERCOMPLAINTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_NATUREOFCUSTOMERCOMPLAINTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_NATUREOFCUSTOMERCOMPLAINTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_NATUREOFCUSTOMERCOMPLAINTS actions', async () => {
      const expectedActions = [
        {
