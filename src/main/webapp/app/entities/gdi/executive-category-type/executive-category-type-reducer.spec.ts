...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_EXECUTIVECATEGORYTYPE_LIST actions', async () => {
    ...
    it('dispatches SEARCH_EXECUTIVECATEGORYTYPES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_EXECUTIVECATEGORYTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_EXECUTIVECATEGORYTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_EXECUTIVECATEGORYTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_EXECUTIVECATEGORYTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_EXECUTIVECATEGORYTYPE actions', async () => {
      const expectedActions = [
        {
