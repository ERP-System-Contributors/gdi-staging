...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_COUNTYCODE_LIST actions', async () => {
    ...
    it('dispatches SEARCH_COUNTYCODES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_COUNTYCODE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_COUNTYCODE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_COUNTYCODE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_COUNTYCODE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_COUNTYCODE actions', async () => {
      const expectedActions = [
        {
