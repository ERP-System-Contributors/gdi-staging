...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ULTIMATEBENEFICIARYTYPES_LIST actions', async () => {
    ...
    it('dispatches SEARCH_ULTIMATEBENEFICIARYTYPES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_ULTIMATEBENEFICIARYTYPES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ULTIMATEBENEFICIARYTYPES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ULTIMATEBENEFICIARYTYPES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ULTIMATEBENEFICIARYTYPES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ULTIMATEBENEFICIARYTYPES actions', async () => {
      const expectedActions = [
        {
