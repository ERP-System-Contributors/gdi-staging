...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CRBREPORTVIEWBAND_LIST actions', async () => {
    ...
    it('dispatches SEARCH_CRBREPORTVIEWBANDS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_CRBREPORTVIEWBAND actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CRBREPORTVIEWBAND actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CRBREPORTVIEWBAND actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CRBREPORTVIEWBAND actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CRBREPORTVIEWBAND actions', async () => {
      const expectedActions = [
        {
