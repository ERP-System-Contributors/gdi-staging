...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CRBFILETRANSMISSIONSTATUS_LIST actions', async () => {
    ...
    it('dispatches SEARCH_CRBFILETRANSMISSIONSTATUSES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_CRBFILETRANSMISSIONSTATUS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CRBFILETRANSMISSIONSTATUS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CRBFILETRANSMISSIONSTATUS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CRBFILETRANSMISSIONSTATUS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CRBFILETRANSMISSIONSTATUS actions', async () => {
      const expectedActions = [
        {
