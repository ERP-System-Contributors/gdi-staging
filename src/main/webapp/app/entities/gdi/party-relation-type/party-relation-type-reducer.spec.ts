...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PARTYRELATIONTYPE_LIST actions', async () => {
    ...
    it('dispatches SEARCH_PARTYRELATIONTYPES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_PARTYRELATIONTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PARTYRELATIONTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PARTYRELATIONTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PARTYRELATIONTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PARTYRELATIONTYPE actions', async () => {
      const expectedActions = [
        {
