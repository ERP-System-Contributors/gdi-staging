...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PRODUCTTYPE_LIST actions', async () => {
    ...
    it('dispatches SEARCH_PRODUCTTYPES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_PRODUCTTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PRODUCTTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PRODUCTTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PRODUCTTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PRODUCTTYPE actions', async () => {
      const expectedActions = [
        {
