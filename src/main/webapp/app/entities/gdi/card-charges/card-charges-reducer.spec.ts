...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CARDCHARGES_LIST actions', async () => {
    ...
    it('dispatches SEARCH_CARDCHARGES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_CARDCHARGES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CARDCHARGES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CARDCHARGES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CARDCHARGES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CARDCHARGES actions', async () => {
      const expectedActions = [
        {
