...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './terminal-functions.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TERMINALFUNCTIONS_LIST actions', async () => {
    ...
    it('dispatches SEARCH_TERMINALFUNCTIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_TERMINALFUNCTIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TERMINALFUNCTIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TERMINALFUNCTIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TERMINALFUNCTIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TERMINALFUNCTIONS actions', async () => {
      const expectedActions = [
        {
