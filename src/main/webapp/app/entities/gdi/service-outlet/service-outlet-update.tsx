...
import { getEntities as getCountyCodes } from 'app/entities/gdi/county-code/county-code.reducer';
  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="gdiStagingApp.gdiServiceOutlet.home.createOrEditLabel" data-cy="ServiceOutletCreateUpdateHeading">
