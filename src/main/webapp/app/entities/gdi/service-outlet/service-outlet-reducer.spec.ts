...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SERVICEOUTLET_LIST actions', async () => {
    ...
    it('dispatches SEARCH_SERVICEOUTLETS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_SERVICEOUTLET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SERVICEOUTLET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SERVICEOUTLET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SERVICEOUTLET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SERVICEOUTLET actions', async () => {
      const expectedActions = [
        {
