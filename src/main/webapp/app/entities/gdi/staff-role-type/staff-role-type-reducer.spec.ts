...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_STAFFROLETYPE_LIST actions', async () => {
    ...
    it('dispatches SEARCH_STAFFROLETYPES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_STAFFROLETYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_STAFFROLETYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_STAFFROLETYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_STAFFROLETYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_STAFFROLETYPE actions', async () => {
      const expectedActions = [
        {
