...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DERIVATIVESUBTYPE_LIST actions', async () => {
    ...
    it('dispatches SEARCH_DERIVATIVESUBTYPES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_DERIVATIVESUBTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_DERIVATIVESUBTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_DERIVATIVESUBTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_DERIVATIVESUBTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_DERIVATIVESUBTYPE actions', async () => {
      const expectedActions = [
        {
