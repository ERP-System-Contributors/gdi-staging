...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CRBCREDITFACILITYTYPE_LIST actions', async () => {
    ...
    it('dispatches SEARCH_CRBCREDITFACILITYTYPES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_CRBCREDITFACILITYTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CRBCREDITFACILITYTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CRBCREDITFACILITYTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CRBCREDITFACILITYTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CRBCREDITFACILITYTYPE actions', async () => {
      const expectedActions = [
        {
