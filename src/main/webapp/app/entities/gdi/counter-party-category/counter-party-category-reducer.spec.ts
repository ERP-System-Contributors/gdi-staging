...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './counter-party-category.reducer';
import { EntityState } from 'app/shared/reducers/reducer.utils';
import { ICounterPartyCategory, defaultValue } from 'app/shared/model/gdi/counter-party-category.model';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_COUNTERPARTYCATEGORY_LIST actions', async () => {
    ...
    it('dispatches SEARCH_COUNTERPARTYCATEGORIES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_COUNTERPARTYCATEGORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_COUNTERPARTYCATEGORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_COUNTERPARTYCATEGORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_COUNTERPARTYCATEGORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_COUNTERPARTYCATEGORY actions', async () => {
      const expectedActions = [
        {
