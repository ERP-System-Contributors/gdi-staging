...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SECURITYTENURE_LIST actions', async () => {
    ...
    it('dispatches SEARCH_SECURITYTENURES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_SECURITYTENURE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SECURITYTENURE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SECURITYTENURE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SECURITYTENURE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SECURITYTENURE actions', async () => {
      const expectedActions = [
        {
