...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CRBDATASUBMITTINGINSTITUTIONS_LIST actions', async () => {
    ...
    it('dispatches SEARCH_CRBDATASUBMITTINGINSTITUTIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_CRBDATASUBMITTINGINSTITUTIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CRBDATASUBMITTINGINSTITUTIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CRBDATASUBMITTINGINSTITUTIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CRBDATASUBMITTINGINSTITUTIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CRBDATASUBMITTINGINSTITUTIONS actions', async () => {
      const expectedActions = [
        {
