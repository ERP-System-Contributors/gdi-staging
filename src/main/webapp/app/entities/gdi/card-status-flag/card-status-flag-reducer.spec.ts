...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CARDSTATUSFLAG_LIST actions', async () => {
    ...
    it('dispatches SEARCH_CARDSTATUSFLAGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_CARDSTATUSFLAG actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CARDSTATUSFLAG actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CARDSTATUSFLAG actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CARDSTATUSFLAG actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CARDSTATUSFLAG actions', async () => {
      const expectedActions = [
        {
