...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './professional-qualification.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PROFESSIONALQUALIFICATION_LIST actions', async () => {
    ...
    it('dispatches SEARCH_PROFESSIONALQUALIFICATIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_PROFESSIONALQUALIFICATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PROFESSIONALQUALIFICATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PROFESSIONALQUALIFICATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PROFESSIONALQUALIFICATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PROFESSIONALQUALIFICATION actions', async () => {
      const expectedActions = [
        {
