...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SUBCOUNTYCODE_LIST actions', async () => {
    ...
    it('dispatches SEARCH_SUBCOUNTYCODES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_SUBCOUNTYCODE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SUBCOUNTYCODE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SUBCOUNTYCODE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SUBCOUNTYCODE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SUBCOUNTYCODE actions', async () => {
      const expectedActions = [
        {
