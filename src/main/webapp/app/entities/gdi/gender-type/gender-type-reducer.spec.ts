...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_GENDERTYPE_LIST actions', async () => {
    ...
    it('dispatches SEARCH_GENDERTYPES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_GENDERTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_GENDERTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_GENDERTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_GENDERTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_GENDERTYPE actions', async () => {
      const expectedActions = [
        {
