...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_COMMITTEETYPE_LIST actions', async () => {
    ...
    it('dispatches SEARCH_COMMITTEETYPES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_COMMITTEETYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_COMMITTEETYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_COMMITTEETYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_COMMITTEETYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_COMMITTEETYPE actions', async () => {
      const expectedActions = [
        {
