...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_OUTLETTYPE_LIST actions', async () => {
    ...
    it('dispatches SEARCH_OUTLETTYPES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_OUTLETTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_OUTLETTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_OUTLETTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_OUTLETTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_OUTLETTYPE actions', async () => {
      const expectedActions = [
        {
