...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CURRENCYSERVICEABILITYFLAG_LIST actions', async () => {
    ...
    it('dispatches SEARCH_CURRENCYSERVICEABILITYFLAGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_CURRENCYSERVICEABILITYFLAG actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CURRENCYSERVICEABILITYFLAG actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CURRENCYSERVICEABILITYFLAG actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CURRENCYSERVICEABILITYFLAG actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CURRENCYSERVICEABILITYFLAG actions', async () => {
      const expectedActions = [
        {
