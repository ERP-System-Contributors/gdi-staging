...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LOANREPAYMENTFREQUENCY_LIST actions', async () => {
    ...
    it('dispatches SEARCH_LOANREPAYMENTFREQUENCIES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_LOANREPAYMENTFREQUENCY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_LOANREPAYMENTFREQUENCY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_LOANREPAYMENTFREQUENCY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_LOANREPAYMENTFREQUENCY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_LOANREPAYMENTFREQUENCY actions', async () => {
      const expectedActions = [
        {
