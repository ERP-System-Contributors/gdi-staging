...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LOANRESTRUCTUREFLAG_LIST actions', async () => {
    ...
    it('dispatches SEARCH_LOANRESTRUCTUREFLAGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_LOANRESTRUCTUREFLAG actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_LOANRESTRUCTUREFLAG actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_LOANRESTRUCTUREFLAG actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_LOANRESTRUCTUREFLAG actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_LOANRESTRUCTUREFLAG actions', async () => {
      const expectedActions = [
        {
