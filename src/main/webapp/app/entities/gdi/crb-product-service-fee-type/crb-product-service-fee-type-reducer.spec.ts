...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CRBPRODUCTSERVICEFEETYPE_LIST actions', async () => {
    ...
    it('dispatches SEARCH_CRBPRODUCTSERVICEFEETYPES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_CRBPRODUCTSERVICEFEETYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CRBPRODUCTSERVICEFEETYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CRBPRODUCTSERVICEFEETYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CRBPRODUCTSERVICEFEETYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CRBPRODUCTSERVICEFEETYPE actions', async () => {
      const expectedActions = [
        {
