...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CHARTOFACCOUNTSCODE_LIST actions', async () => {
    ...
    it('dispatches SEARCH_CHARTOFACCOUNTSCODES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_CHARTOFACCOUNTSCODE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CHARTOFACCOUNTSCODE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CHARTOFACCOUNTSCODE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CHARTOFACCOUNTSCODE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CHARTOFACCOUNTSCODE actions', async () => {
      const expectedActions = [
        {
