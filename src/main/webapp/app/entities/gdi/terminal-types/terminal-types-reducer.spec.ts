...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TERMINALTYPES_LIST actions', async () => {
    ...
    it('dispatches SEARCH_TERMINALTYPES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_TERMINALTYPES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TERMINALTYPES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TERMINALTYPES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TERMINALTYPES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TERMINALTYPES actions', async () => {
      const expectedActions = [
        {
