...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FRAUDTYPE_LIST actions', async () => {
    ...
    it('dispatches SEARCH_FRAUDTYPES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_FRAUDTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_FRAUDTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_FRAUDTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_FRAUDTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_FRAUDTYPE actions', async () => {
      const expectedActions = [
        {
