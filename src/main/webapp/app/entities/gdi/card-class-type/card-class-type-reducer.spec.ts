...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './card-class-type.reducer';
import { EntityState } from 'app/shared/reducers/reducer.utils';
import { ICardClassType, defaultValue } from 'app/shared/model/gdi/card-class-type.model';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CARDCLASSTYPE_LIST actions', async () => {
    ...
    it('dispatches SEARCH_CARDCLASSTYPES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_CARDCLASSTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CARDCLASSTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CARDCLASSTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CARDCLASSTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CARDCLASSTYPE actions', async () => {
      const expectedActions = [
        {
