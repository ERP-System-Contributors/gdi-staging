...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CRBCUSTOMERTYPE_LIST actions', async () => {
    ...
    it('dispatches SEARCH_CRBCUSTOMERTYPES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_CRBCUSTOMERTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CRBCUSTOMERTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CRBCUSTOMERTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CRBCUSTOMERTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CRBCUSTOMERTYPE actions', async () => {
      const expectedActions = [
        {
