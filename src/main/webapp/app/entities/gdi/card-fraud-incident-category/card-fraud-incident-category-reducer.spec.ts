...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CARDFRAUDINCIDENTCATEGORY_LIST actions', async () => {
    ...
    it('dispatches SEARCH_CARDFRAUDINCIDENTCATEGORIES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_CARDFRAUDINCIDENTCATEGORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CARDFRAUDINCIDENTCATEGORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CARDFRAUDINCIDENTCATEGORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CARDFRAUDINCIDENTCATEGORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CARDFRAUDINCIDENTCATEGORY actions', async () => {
      const expectedActions = [
        {
