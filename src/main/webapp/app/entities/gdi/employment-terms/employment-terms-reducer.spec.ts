...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_EMPLOYMENTTERMS_LIST actions', async () => {
    ...
    it('dispatches SEARCH_EMPLOYMENTTERMS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_EMPLOYMENTTERMS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_EMPLOYMENTTERMS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_EMPLOYMENTTERMS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_EMPLOYMENTTERMS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_EMPLOYMENTTERMS actions', async () => {
      const expectedActions = [
        {
