...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FXRATETYPE_LIST actions', async () => {
    ...
    it('dispatches SEARCH_FXRATETYPES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_FXRATETYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_FXRATETYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_FXRATETYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_FXRATETYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_FXRATETYPE actions', async () => {
      const expectedActions = [
        {
