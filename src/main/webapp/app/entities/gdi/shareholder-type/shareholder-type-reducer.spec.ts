...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SHAREHOLDERTYPE_LIST actions', async () => {
    ...
    it('dispatches SEARCH_SHAREHOLDERTYPES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_SHAREHOLDERTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SHAREHOLDERTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SHAREHOLDERTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SHAREHOLDERTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SHAREHOLDERTYPE actions', async () => {
      const expectedActions = [
        {
