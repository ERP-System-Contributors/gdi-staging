...
import { getEntity, deleteEntity } from './channel-type.reducer';
...
export const ChannelTypeDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="gdiStagingApp.gdiChannelType.delete.question">
        Are you sure you want to delete Channel Type {channelTypeEntity.id}?
      </ModalBody>
      <ModalFooter>
