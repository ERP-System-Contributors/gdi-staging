...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MORATORIUMITEM_LIST actions', async () => {
    ...
    it('dispatches SEARCH_MORATORIUMITEMS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_MORATORIUMITEM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_MORATORIUMITEM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_MORATORIUMITEM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_MORATORIUMITEM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_MORATORIUMITEM actions', async () => {
      const expectedActions = [
        {
