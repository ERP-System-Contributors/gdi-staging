...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MANAGEMENTMEMBERTYPE_LIST actions', async () => {
    ...
    it('dispatches SEARCH_MANAGEMENTMEMBERTYPES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_MANAGEMENTMEMBERTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_MANAGEMENTMEMBERTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_MANAGEMENTMEMBERTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_MANAGEMENTMEMBERTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_MANAGEMENTMEMBERTYPE actions', async () => {
      const expectedActions = [
        {
