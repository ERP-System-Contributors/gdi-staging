...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CRBAGINGBANDS_LIST actions', async () => {
    ...
    it('dispatches SEARCH_CRBAGINGBANDS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_CRBAGINGBANDS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CRBAGINGBANDS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CRBAGINGBANDS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CRBAGINGBANDS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CRBAGINGBANDS actions', async () => {
      const expectedActions = [
        {
