...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SOURCESOFFUNDSTYPECODE_LIST actions', async () => {
    ...
    it('dispatches SEARCH_SOURCESOFFUNDSTYPECODES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_SOURCESOFFUNDSTYPECODE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SOURCESOFFUNDSTYPECODE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SOURCESOFFUNDSTYPECODE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SOURCESOFFUNDSTYPECODE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SOURCESOFFUNDSTYPECODE actions', async () => {
      const expectedActions = [
        {
