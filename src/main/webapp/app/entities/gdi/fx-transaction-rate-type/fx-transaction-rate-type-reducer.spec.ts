...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './fx-transaction-rate-type.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FXTRANSACTIONRATETYPE_LIST actions', async () => {
    ...
    it('dispatches SEARCH_FXTRANSACTIONRATETYPES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_FXTRANSACTIONRATETYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_FXTRANSACTIONRATETYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_FXTRANSACTIONRATETYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_FXTRANSACTIONRATETYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_FXTRANSACTIONRATETYPE actions', async () => {
      const expectedActions = [
        {
