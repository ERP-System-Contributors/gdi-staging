...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ISICECONOMICACTIVITY_LIST actions', async () => {
    ...
    it('dispatches SEARCH_ISICECONOMICACTIVITIES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_ISICECONOMICACTIVITY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ISICECONOMICACTIVITY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ISICECONOMICACTIVITY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ISICECONOMICACTIVITY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ISICECONOMICACTIVITY actions', async () => {
      const expectedActions = [
        {
