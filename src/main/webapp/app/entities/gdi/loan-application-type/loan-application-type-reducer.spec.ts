...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './loan-application-type.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LOANAPPLICATIONTYPE_LIST actions', async () => {
    ...
    it('dispatches SEARCH_LOANAPPLICATIONTYPES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_LOANAPPLICATIONTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_LOANAPPLICATIONTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_LOANAPPLICATIONTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_LOANAPPLICATIONTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_LOANAPPLICATIONTYPE actions', async () => {
      const expectedActions = [
        {
