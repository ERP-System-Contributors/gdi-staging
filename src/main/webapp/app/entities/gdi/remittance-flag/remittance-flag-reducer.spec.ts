...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_REMITTANCEFLAG_LIST actions', async () => {
    ...
    it('dispatches SEARCH_REMITTANCEFLAGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_REMITTANCEFLAG actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_REMITTANCEFLAG actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_REMITTANCEFLAG actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_REMITTANCEFLAG actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_REMITTANCEFLAG actions', async () => {
      const expectedActions = [
        {
