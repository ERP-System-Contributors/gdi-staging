...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './universally-unique-mapping.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_UNIVERSALLYUNIQUEMAPPING_LIST actions', async () => {
    ...
    it('dispatches SEARCH_UNIVERSALLYUNIQUEMAPPINGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_UNIVERSALLYUNIQUEMAPPING actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_UNIVERSALLYUNIQUEMAPPING actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_UNIVERSALLYUNIQUEMAPPING actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_UNIVERSALLYUNIQUEMAPPING actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_UNIVERSALLYUNIQUEMAPPING actions', async () => {
      const expectedActions = [
        {
