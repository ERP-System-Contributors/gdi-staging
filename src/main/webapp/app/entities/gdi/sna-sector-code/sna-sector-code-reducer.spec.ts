...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SNASECTORCODE_LIST actions', async () => {
    ...
    it('dispatches SEARCH_SNASECTORCODES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_SNASECTORCODE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SNASECTORCODE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SNASECTORCODE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SNASECTORCODE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SNASECTORCODE actions', async () => {
      const expectedActions = [
        {
