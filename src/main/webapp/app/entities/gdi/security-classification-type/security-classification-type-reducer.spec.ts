...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SECURITYCLASSIFICATIONTYPE_LIST actions', async () => {
    ...
    it('dispatches SEARCH_SECURITYCLASSIFICATIONTYPES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_SECURITYCLASSIFICATIONTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SECURITYCLASSIFICATIONTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SECURITYCLASSIFICATIONTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SECURITYCLASSIFICATIONTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SECURITYCLASSIFICATIONTYPE actions', async () => {
      const expectedActions = [
        {
