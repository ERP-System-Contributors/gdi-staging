...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CRBSUBSCRIPTIONSTATUSTYPECODE_LIST actions', async () => {
    ...
    it('dispatches SEARCH_CRBSUBSCRIPTIONSTATUSTYPECODES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_CRBSUBSCRIPTIONSTATUSTYPECODE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CRBSUBSCRIPTIONSTATUSTYPECODE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CRBSUBSCRIPTIONSTATUSTYPECODE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CRBSUBSCRIPTIONSTATUSTYPECODE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CRBSUBSCRIPTIONSTATUSTYPECODE actions', async () => {
      const expectedActions = [
        {
