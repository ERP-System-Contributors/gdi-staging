...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CARDPERFORMANCEFLAG_LIST actions', async () => {
    ...
    it('dispatches SEARCH_CARDPERFORMANCEFLAGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_CARDPERFORMANCEFLAG actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CARDPERFORMANCEFLAG actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CARDPERFORMANCEFLAG actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CARDPERFORMANCEFLAG actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CARDPERFORMANCEFLAG actions', async () => {
      const expectedActions = [
        {
