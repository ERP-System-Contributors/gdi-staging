...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CUSTOMERCOMPLAINTSTATUSTYPE_LIST actions', async () => {
    ...
    it('dispatches SEARCH_CUSTOMERCOMPLAINTSTATUSTYPES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_CUSTOMERCOMPLAINTSTATUSTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CUSTOMERCOMPLAINTSTATUSTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CUSTOMERCOMPLAINTSTATUSTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CUSTOMERCOMPLAINTSTATUSTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CUSTOMERCOMPLAINTSTATUSTYPE actions', async () => {
      const expectedActions = [
        {
