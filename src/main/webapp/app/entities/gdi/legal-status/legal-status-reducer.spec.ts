...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LEGALSTATUS_LIST actions', async () => {
    ...
    it('dispatches SEARCH_LEGALSTATUSES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_LEGALSTATUS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_LEGALSTATUS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_LEGALSTATUS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_LEGALSTATUS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_LEGALSTATUS actions', async () => {
      const expectedActions = [
        {
