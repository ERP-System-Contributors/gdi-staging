...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_GLMAPPING_LIST actions', async () => {
    ...
    it('dispatches SEARCH_GLMAPPINGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_GLMAPPING actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_GLMAPPING actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_GLMAPPING actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_GLMAPPING actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_GLMAPPING actions', async () => {
      const expectedActions = [
        {
