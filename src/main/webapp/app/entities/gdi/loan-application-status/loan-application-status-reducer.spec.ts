...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './loan-application-status.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LOANAPPLICATIONSTATUS_LIST actions', async () => {
    ...
    it('dispatches SEARCH_LOANAPPLICATIONSTATUSES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_LOANAPPLICATIONSTATUS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_LOANAPPLICATIONSTATUS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_LOANAPPLICATIONSTATUS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_LOANAPPLICATIONSTATUS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_LOANAPPLICATIONSTATUS actions', async () => {
      const expectedActions = [
        {
