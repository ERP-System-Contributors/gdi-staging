...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SETTLEMENTCURRENCY_LIST actions', async () => {
    ...
    it('dispatches SEARCH_SETTLEMENTCURRENCIES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_SETTLEMENTCURRENCY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SETTLEMENTCURRENCY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SETTLEMENTCURRENCY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SETTLEMENTCURRENCY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SETTLEMENTCURRENCY actions', async () => {
      const expectedActions = [
        {
