...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LOANACCOUNTCATEGORY_LIST actions', async () => {
    ...
    it('dispatches SEARCH_LOANACCOUNTCATEGORIES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_LOANACCOUNTCATEGORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_LOANACCOUNTCATEGORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_LOANACCOUNTCATEGORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_LOANACCOUNTCATEGORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_LOANACCOUNTCATEGORY actions', async () => {
      const expectedActions = [
        {
