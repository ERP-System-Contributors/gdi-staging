...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ISSUERSOFSECURITIES_LIST actions', async () => {
    ...
    it('dispatches SEARCH_ISSUERSOFSECURITIES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_ISSUERSOFSECURITIES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ISSUERSOFSECURITIES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ISSUERSOFSECURITIES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ISSUERSOFSECURITIES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ISSUERSOFSECURITIES actions', async () => {
      const expectedActions = [
        {
