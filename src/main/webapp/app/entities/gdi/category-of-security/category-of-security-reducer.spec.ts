...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CATEGORYOFSECURITY_LIST actions', async () => {
    ...
    it('dispatches SEARCH_CATEGORYOFSECURITIES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_CATEGORYOFSECURITY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CATEGORYOFSECURITY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CATEGORYOFSECURITY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CATEGORYOFSECURITY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CATEGORYOFSECURITY actions', async () => {
      const expectedActions = [
        {
