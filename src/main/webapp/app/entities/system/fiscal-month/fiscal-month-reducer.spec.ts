...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FISCALMONTH_LIST actions', async () => {
    ...
    it('dispatches SEARCH_FISCALMONTHS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_FISCALMONTH actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_FISCALMONTH actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_FISCALMONTH actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_FISCALMONTH actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_FISCALMONTH actions', async () => {
      const expectedActions = [
        {
