...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FISCALQUARTER_LIST actions', async () => {
    ...
    it('dispatches SEARCH_FISCALQUARTERS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_FISCALQUARTER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_FISCALQUARTER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_FISCALQUARTER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_FISCALQUARTER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_FISCALQUARTER actions', async () => {
      const expectedActions = [
        {
