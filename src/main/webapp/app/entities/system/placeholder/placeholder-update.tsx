  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="gdiStagingApp.systemPlaceholder.home.createOrEditLabel" data-cy="PlaceholderCreateUpdateHeading">
          ...
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                ...
                id="placeholder-fileUploadToken"
              ...
              <ValidatedField
                ...
                id="placeholder-compilationToken"
