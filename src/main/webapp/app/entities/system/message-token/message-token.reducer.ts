...
const apiSearchUrl = 'services/erpservice/api/_search/message-tokens';

// Actions

export const searchEntities = createAsyncThunk('messageToken/search_entity', async ({ query, page, size, sort }: IQueryParams) => {
