...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './message-token.reducer';
import { EntityState } from 'app/shared/reducers/reducer.utils';
import { IMessageToken, defaultValue } from 'app/shared/model/system/message-token.model';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MESSAGETOKEN_LIST actions', async () => {
    ...
    it('dispatches SEARCH_MESSAGETOKENS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_MESSAGETOKEN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_MESSAGETOKEN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_MESSAGETOKEN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_MESSAGETOKEN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_MESSAGETOKEN actions', async () => {
      const expectedActions = [
        {
