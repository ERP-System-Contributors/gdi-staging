...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_QUESTIONBASE_LIST actions', async () => {
    ...
    it('dispatches SEARCH_QUESTIONBASES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_QUESTIONBASE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_QUESTIONBASE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_QUESTIONBASE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_QUESTIONBASE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_QUESTIONBASE actions', async () => {
      const expectedActions = [
        {
