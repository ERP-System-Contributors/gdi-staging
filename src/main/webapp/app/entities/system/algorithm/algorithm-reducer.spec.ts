...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ALGORITHM_LIST actions', async () => {
    ...
    it('dispatches SEARCH_ALGORITHMS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_ALGORITHM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ALGORITHM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ALGORITHM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ALGORITHM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ALGORITHM actions', async () => {
      const expectedActions = [
        {
