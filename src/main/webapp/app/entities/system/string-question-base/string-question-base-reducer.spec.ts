...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './string-question-base.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_STRINGQUESTIONBASE_LIST actions', async () => {
    ...
    it('dispatches SEARCH_STRINGQUESTIONBASES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_STRINGQUESTIONBASE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_STRINGQUESTIONBASE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_STRINGQUESTIONBASE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_STRINGQUESTIONBASE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_STRINGQUESTIONBASE actions', async () => {
      const expectedActions = [
        {
