...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SYSTEMMODULE_LIST actions', async () => {
    ...
    it('dispatches SEARCH_SYSTEMMODULES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_SYSTEMMODULE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SYSTEMMODULE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SYSTEMMODULE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SYSTEMMODULE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SYSTEMMODULE actions', async () => {
      const expectedActions = [
        {
