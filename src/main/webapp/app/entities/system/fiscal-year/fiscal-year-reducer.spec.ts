...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FISCALYEAR_LIST actions', async () => {
    ...
    it('dispatches SEARCH_FISCALYEARS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_FISCALYEAR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_FISCALYEAR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_FISCALYEAR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_FISCALYEAR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_FISCALYEAR actions', async () => {
      const expectedActions = [
        {
