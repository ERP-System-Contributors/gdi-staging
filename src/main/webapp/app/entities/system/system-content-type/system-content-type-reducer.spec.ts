...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './system-content-type.reducer';
import { EntityState } from 'app/shared/reducers/reducer.utils';
import { ISystemContentType, defaultValue } from 'app/shared/model/system/system-content-type.model';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SYSTEMCONTENTTYPE_LIST actions', async () => {
    ...
    it('dispatches SEARCH_SYSTEMCONTENTTYPES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_SYSTEMCONTENTTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SYSTEMCONTENTTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SYSTEMCONTENTTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SYSTEMCONTENTTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SYSTEMCONTENTTYPE actions', async () => {
      const expectedActions = [
        {
