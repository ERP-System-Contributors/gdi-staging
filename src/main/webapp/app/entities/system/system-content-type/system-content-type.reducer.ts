...
const apiSearchUrl = 'api/_search/system-content-types';

// Actions

export const searchEntities = createAsyncThunk('systemContentType/search_entity', async ({ query, page, size, sort }: IQueryParams) => {
