...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './contract-metadata.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CONTRACTMETADATA_LIST actions', async () => {
    ...
    it('dispatches SEARCH_CONTRACTMETADATA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_CONTRACTMETADATA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CONTRACTMETADATA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CONTRACTMETADATA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CONTRACTMETADATA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CONTRACTMETADATA actions', async () => {
      const expectedActions = [
        {
