...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './payment-calculation.reducer';
import { EntityState } from 'app/shared/reducers/reducer.utils';
import { IPaymentCalculation, defaultValue } from 'app/shared/model/settlement/payment-calculation.model';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PAYMENTCALCULATION_LIST actions', async () => {
    ...
    it('dispatches SEARCH_PAYMENTCALCULATIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_PAYMENTCALCULATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PAYMENTCALCULATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PAYMENTCALCULATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PAYMENTCALCULATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PAYMENTCALCULATION actions', async () => {
      const expectedActions = [
        {
