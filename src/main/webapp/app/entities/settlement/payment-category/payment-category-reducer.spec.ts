...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PAYMENTCATEGORY_LIST actions', async () => {
    ...
    it('dispatches SEARCH_PAYMENTCATEGORIES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_PAYMENTCATEGORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PAYMENTCATEGORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PAYMENTCATEGORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PAYMENTCATEGORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PAYMENTCATEGORY actions', async () => {
      const expectedActions = [
        {
