...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PAYMENTINVOICE_LIST actions', async () => {
    ...
    it('dispatches SEARCH_PAYMENTINVOICES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_PAYMENTINVOICE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PAYMENTINVOICE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PAYMENTINVOICE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PAYMENTINVOICE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PAYMENTINVOICE actions', async () => {
      const expectedActions = [
        {
