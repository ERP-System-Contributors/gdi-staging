...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SIGNEDPAYMENT_LIST actions', async () => {
    ...
    it('dispatches SEARCH_SIGNEDPAYMENTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_SIGNEDPAYMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SIGNEDPAYMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SIGNEDPAYMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SIGNEDPAYMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SIGNEDPAYMENT actions', async () => {
      const expectedActions = [
        {
