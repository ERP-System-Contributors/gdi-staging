...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './credit-note.reducer';
import { EntityState } from 'app/shared/reducers/reducer.utils';
import { ICreditNote, defaultValue } from 'app/shared/model/settlement/credit-note.model';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CREDITNOTE_LIST actions', async () => {
    ...
    it('dispatches SEARCH_CREDITNOTES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_CREDITNOTE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CREDITNOTE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CREDITNOTE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CREDITNOTE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CREDITNOTE actions', async () => {
      const expectedActions = [
        {
