...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './settlement-requisition.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SETTLEMENTREQUISITION_LIST actions', async () => {
    ...
    it('dispatches SEARCH_SETTLEMENTREQUISITIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_SETTLEMENTREQUISITION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SETTLEMENTREQUISITION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SETTLEMENTREQUISITION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SETTLEMENTREQUISITION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SETTLEMENTREQUISITION actions', async () => {
      const expectedActions = [
        {
