...
import { IPayment, defaultValue } from 'app/shared/model/settlement/payment.model';
...
const apiUrl = 'services/erpservice/api/payments';
const apiSearchUrl = 'services/erpservice/api/_search/payments';

// Actions

export const searchEntities = createAsyncThunk('payment/search_entity', async ({ query, page, size, sort }: IQueryParams) => {
