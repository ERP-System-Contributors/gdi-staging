...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './settlement.reducer';
import { EntityState } from 'app/shared/reducers/reducer.utils';
import { ISettlement, defaultValue } from 'app/shared/model/settlement/settlement.model';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SETTLEMENT_LIST actions', async () => {
    ...
    it('dispatches SEARCH_SETTLEMENTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_SETTLEMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SETTLEMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SETTLEMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SETTLEMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SETTLEMENT actions', async () => {
      const expectedActions = [
        {
