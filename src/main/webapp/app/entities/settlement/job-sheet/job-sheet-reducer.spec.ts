...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './job-sheet.reducer';
import { EntityState } from 'app/shared/reducers/reducer.utils';
import { IJobSheet, defaultValue } from 'app/shared/model/settlement/job-sheet.model';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_JOBSHEET_LIST actions', async () => {
    ...
    it('dispatches SEARCH_JOBSHEETS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_JOBSHEET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_JOBSHEET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_JOBSHEET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_JOBSHEET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_JOBSHEET actions', async () => {
      const expectedActions = [
        {
