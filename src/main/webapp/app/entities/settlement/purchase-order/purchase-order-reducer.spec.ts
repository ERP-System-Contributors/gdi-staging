...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PURCHASEORDER_LIST actions', async () => {
    ...
    it('dispatches SEARCH_PURCHASEORDERS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_PURCHASEORDER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PURCHASEORDER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PURCHASEORDER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PURCHASEORDER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PURCHASEORDER actions', async () => {
      const expectedActions = [
        {
