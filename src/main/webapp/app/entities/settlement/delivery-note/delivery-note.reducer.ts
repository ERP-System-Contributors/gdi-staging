...
const apiSearchUrl = 'api/_search/delivery-notes';

// Actions

export const searchEntities = createAsyncThunk('deliveryNote/search_entity', async ({ query, page, size, sort }: IQueryParams) => {
