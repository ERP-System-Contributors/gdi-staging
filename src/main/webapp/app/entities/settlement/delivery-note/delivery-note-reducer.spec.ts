...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './delivery-note.reducer';
import { EntityState } from 'app/shared/reducers/reducer.utils';
import { IDeliveryNote, defaultValue } from 'app/shared/model/settlement/delivery-note.model';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DELIVERYNOTE_LIST actions', async () => {
    ...
    it('dispatches SEARCH_DELIVERYNOTES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_DELIVERYNOTE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_DELIVERYNOTE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_DELIVERYNOTE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_DELIVERYNOTE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_DELIVERYNOTE actions', async () => {
      const expectedActions = [
        {
