...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PAYMENTLABEL_LIST actions', async () => {
    ...
    it('dispatches SEARCH_PAYMENTLABELS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_PAYMENTLABEL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PAYMENTLABEL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PAYMENTLABEL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PAYMENTLABEL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PAYMENTLABEL actions', async () => {
      const expectedActions = [
        {
