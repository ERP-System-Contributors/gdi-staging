...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BUSINESSSTAMP_LIST actions', async () => {
    ...
    it('dispatches SEARCH_BUSINESSSTAMPS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_BUSINESSSTAMP actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_BUSINESSSTAMP actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_BUSINESSSTAMP actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_BUSINESSSTAMP actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_BUSINESSSTAMP actions', async () => {
      const expectedActions = [
        {
