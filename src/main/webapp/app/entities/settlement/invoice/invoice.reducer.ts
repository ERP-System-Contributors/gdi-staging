...
import { IInvoice, defaultValue } from 'app/shared/model/settlement/invoice.model';
...
const apiUrl = 'services/erpservice/api/invoices';
const apiSearchUrl = 'services/erpservice/api/_search/invoices';
