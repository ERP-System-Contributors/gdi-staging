...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './payment-requisition.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PAYMENTREQUISITION_LIST actions', async () => {
    ...
    it('dispatches SEARCH_PAYMENTREQUISITIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_PAYMENTREQUISITION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PAYMENTREQUISITION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PAYMENTREQUISITION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PAYMENTREQUISITION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PAYMENTREQUISITION actions', async () => {
      const expectedActions = [
        {
