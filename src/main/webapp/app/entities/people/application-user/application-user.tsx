...
import { searchEntities, getEntities } from './application-user.reducer';
          ...
          <Table responsive>
            <thead>
              <tr>
                ...
                <th>
                  Dealer Identity <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
                ...
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>
                    {applicationUser.organization ? (
                      <Link to={`/dealer/${applicationUser.organization.id}`}>{applicationUser.organization.dealerName}</Link>
                    ) : (
                      ''
                    )}
                  </td>
                  <td>
                    {applicationUser.department ? (
                      <Link to={`/dealer/${applicationUser.department.id}`}>{applicationUser.department.dealerName}</Link>
                    ) : (
                      ''
                    )}
                  </td>
                  <td>
                    {applicationUser.securityClearance ? (
                      <Link to={`/security-clearance/${applicationUser.securityClearance.id}`}>
                  ...
                  <td>
                    {applicationUser.dealerIdentity ? (
                      <Link to={`/dealer/${applicationUser.dealerIdentity.id}`}>{applicationUser.dealerIdentity.dealerName}</Link>
                    ) : (
                      ''
                    )}
                  </td>
