...
import { IDealer, defaultValue } from 'app/shared/model/people/dealer.model';
...
const apiUrl = 'services/erpservice/api/dealers';
const apiSearchUrl = 'services/erpservice/api/_search/dealers';
