...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './security-clearance.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SECURITYCLEARANCE_LIST actions', async () => {
    ...
    it('dispatches SEARCH_SECURITYCLEARANCES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_SECURITYCLEARANCE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SECURITYCLEARANCE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SECURITYCLEARANCE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SECURITYCLEARANCE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SECURITYCLEARANCE actions', async () => {
      const expectedActions = [
        {
