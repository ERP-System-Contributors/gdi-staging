...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './related-party-relationship.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_RELATEDPARTYRELATIONSHIP_LIST actions', async () => {
    ...
    it('dispatches SEARCH_RELATEDPARTYRELATIONSHIPS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_RELATEDPARTYRELATIONSHIP actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_RELATEDPARTYRELATIONSHIP actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_RELATEDPARTYRELATIONSHIP actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_RELATEDPARTYRELATIONSHIP actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_RELATEDPARTYRELATIONSHIP actions', async () => {
      const expectedActions = [
        {
