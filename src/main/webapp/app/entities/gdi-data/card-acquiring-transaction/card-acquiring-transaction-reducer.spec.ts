...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './card-acquiring-transaction.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CARDACQUIRINGTRANSACTION_LIST actions', async () => {
    ...
    it('dispatches SEARCH_CARDACQUIRINGTRANSACTIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_CARDACQUIRINGTRANSACTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CARDACQUIRINGTRANSACTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CARDACQUIRINGTRANSACTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CARDACQUIRINGTRANSACTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CARDACQUIRINGTRANSACTION actions', async () => {
      const expectedActions = [
        {
