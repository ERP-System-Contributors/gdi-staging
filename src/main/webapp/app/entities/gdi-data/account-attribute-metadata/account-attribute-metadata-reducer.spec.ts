...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './account-attribute-metadata.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ACCOUNTATTRIBUTEMETADATA_LIST actions', async () => {
    ...
    it('dispatches SEARCH_ACCOUNTATTRIBUTEMETADATA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_ACCOUNTATTRIBUTEMETADATA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ACCOUNTATTRIBUTEMETADATA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ACCOUNTATTRIBUTEMETADATA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ACCOUNTATTRIBUTEMETADATA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ACCOUNTATTRIBUTEMETADATA actions', async () => {
      const expectedActions = [
        {
