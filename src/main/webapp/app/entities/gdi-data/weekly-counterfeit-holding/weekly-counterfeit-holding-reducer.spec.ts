...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './weekly-counterfeit-holding.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_WEEKLYCOUNTERFEITHOLDING_LIST actions', async () => {
    ...
    it('dispatches SEARCH_WEEKLYCOUNTERFEITHOLDINGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_WEEKLYCOUNTERFEITHOLDING actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_WEEKLYCOUNTERFEITHOLDING actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_WEEKLYCOUNTERFEITHOLDING actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_WEEKLYCOUNTERFEITHOLDING actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_WEEKLYCOUNTERFEITHOLDING actions', async () => {
      const expectedActions = [
        {
