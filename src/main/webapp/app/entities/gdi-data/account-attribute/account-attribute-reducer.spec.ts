...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './account-attribute.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ACCOUNTATTRIBUTE_LIST actions', async () => {
    ...
    it('dispatches SEARCH_ACCOUNTATTRIBUTES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_ACCOUNTATTRIBUTE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ACCOUNTATTRIBUTE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ACCOUNTATTRIBUTE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ACCOUNTATTRIBUTE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ACCOUNTATTRIBUTE actions', async () => {
      const expectedActions = [
        {
