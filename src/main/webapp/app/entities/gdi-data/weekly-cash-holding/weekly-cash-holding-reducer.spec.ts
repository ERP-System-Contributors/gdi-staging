...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './weekly-cash-holding.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_WEEKLYCASHHOLDING_LIST actions', async () => {
    ...
    it('dispatches SEARCH_WEEKLYCASHHOLDINGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_WEEKLYCASHHOLDING actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_WEEKLYCASHHOLDING actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_WEEKLYCASHHOLDING actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_WEEKLYCASHHOLDING actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_WEEKLYCASHHOLDING actions', async () => {
      const expectedActions = [
        {
