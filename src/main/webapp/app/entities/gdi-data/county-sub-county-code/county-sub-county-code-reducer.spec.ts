...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './county-sub-county-code.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_COUNTYSUBCOUNTYCODE_LIST actions', async () => {
    ...
    it('dispatches SEARCH_COUNTYSUBCOUNTYCODES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_COUNTYSUBCOUNTYCODE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_COUNTYSUBCOUNTYCODE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_COUNTYSUBCOUNTYCODE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_COUNTYSUBCOUNTYCODE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_COUNTYSUBCOUNTYCODE actions', async () => {
      const expectedActions = [
        {
