...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './card-fraud-information.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CARDFRAUDINFORMATION_LIST actions', async () => {
    ...
    it('dispatches SEARCH_CARDFRAUDINFORMATIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_CARDFRAUDINFORMATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CARDFRAUDINFORMATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CARDFRAUDINFORMATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CARDFRAUDINFORMATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CARDFRAUDINFORMATION actions', async () => {
      const expectedActions = [
        {
