...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TAXRULE_LIST actions', async () => {
    ...
    it('dispatches SEARCH_TAXRULES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_TAXRULE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TAXRULE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TAXRULE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TAXRULE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TAXRULE actions', async () => {
      const expectedActions = [
        {
