...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_AGENCYNOTICE_LIST actions', async () => {
    ...
    it('dispatches SEARCH_AGENCYNOTICES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_AGENCYNOTICE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_AGENCYNOTICE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_AGENCYNOTICE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_AGENCYNOTICE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_AGENCYNOTICE actions', async () => {
      const expectedActions = [
        {
