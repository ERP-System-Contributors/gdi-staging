...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './tax-reference.reducer';
import { EntityState } from 'app/shared/reducers/reducer.utils';
import { ITaxReference, defaultValue } from 'app/shared/model/tax/tax-reference.model';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TAXREFERENCE_LIST actions', async () => {
    ...
    it('dispatches SEARCH_TAXREFERENCES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_TAXREFERENCE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TAXREFERENCE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TAXREFERENCE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TAXREFERENCE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TAXREFERENCE actions', async () => {
      const expectedActions = [
        {
