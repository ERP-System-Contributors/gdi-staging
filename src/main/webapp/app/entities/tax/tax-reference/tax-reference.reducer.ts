...
const apiSearchUrl = 'services/erpservice/api/_search/tax-references';

// Actions

export const searchEntities = createAsyncThunk('taxReference/search_entity', async ({ query, page, size, sort }: IQueryParams) => {
