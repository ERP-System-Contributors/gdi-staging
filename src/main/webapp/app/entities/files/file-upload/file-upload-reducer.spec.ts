...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FILEUPLOAD_LIST actions', async () => {
    ...
    it('dispatches SEARCH_FILEUPLOADS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_FILEUPLOAD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_FILEUPLOAD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_FILEUPLOAD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_FILEUPLOAD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_FILEUPLOAD actions', async () => {
      const expectedActions = [
        {
