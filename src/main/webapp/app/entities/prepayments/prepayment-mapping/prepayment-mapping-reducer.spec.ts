...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './prepayment-mapping.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PREPAYMENTMAPPING_LIST actions', async () => {
    ...
    it('dispatches SEARCH_PREPAYMENTMAPPINGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_PREPAYMENTMAPPING actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PREPAYMENTMAPPING actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PREPAYMENTMAPPING actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PREPAYMENTMAPPING actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PREPAYMENTMAPPING actions', async () => {
      const expectedActions = [
        {
