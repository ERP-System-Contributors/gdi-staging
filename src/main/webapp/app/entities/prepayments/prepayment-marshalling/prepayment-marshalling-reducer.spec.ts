...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './prepayment-marshalling.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PREPAYMENTMARSHALLING_LIST actions', async () => {
    ...
    it('dispatches SEARCH_PREPAYMENTMARSHALLINGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_PREPAYMENTMARSHALLING actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PREPAYMENTMARSHALLING actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PREPAYMENTMARSHALLING actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PREPAYMENTMARSHALLING actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PREPAYMENTMARSHALLING actions', async () => {
      const expectedActions = [
        {
