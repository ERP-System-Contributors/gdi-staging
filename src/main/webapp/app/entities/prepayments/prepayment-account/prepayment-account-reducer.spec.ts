...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './prepayment-account.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PREPAYMENTACCOUNT_LIST actions', async () => {
    ...
    it('dispatches SEARCH_PREPAYMENTACCOUNTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_PREPAYMENTACCOUNT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PREPAYMENTACCOUNT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PREPAYMENTACCOUNT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PREPAYMENTACCOUNT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PREPAYMENTACCOUNT actions', async () => {
      const expectedActions = [
        {
