...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './prepayment-amortization.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PREPAYMENTAMORTIZATION_LIST actions', async () => {
    ...
    it('dispatches SEARCH_PREPAYMENTAMORTIZATIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_PREPAYMENTAMORTIZATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PREPAYMENTAMORTIZATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PREPAYMENTAMORTIZATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PREPAYMENTAMORTIZATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PREPAYMENTAMORTIZATION actions', async () => {
      const expectedActions = [
        {
