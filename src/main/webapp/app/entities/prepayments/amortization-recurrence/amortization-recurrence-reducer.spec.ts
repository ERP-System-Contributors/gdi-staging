...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './amortization-recurrence.reducer';
import { EntityState } from 'app/shared/reducers/reducer.utils';
import { IAmortizationRecurrence, defaultValue } from 'app/shared/model/prepayments/amortization-recurrence.model';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_AMORTIZATIONRECURRENCE_LIST actions', async () => {
    ...
    it('dispatches SEARCH_AMORTIZATIONRECURRENCES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_AMORTIZATIONRECURRENCE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_AMORTIZATIONRECURRENCE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_AMORTIZATIONRECURRENCE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_AMORTIZATIONRECURRENCE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_AMORTIZATIONRECURRENCE actions', async () => {
      const expectedActions = [
        {
