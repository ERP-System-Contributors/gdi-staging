...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './amortization-sequence.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_AMORTIZATIONSEQUENCE_LIST actions', async () => {
    ...
    it('dispatches SEARCH_AMORTIZATIONSEQUENCES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_AMORTIZATIONSEQUENCE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_AMORTIZATIONSEQUENCE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_AMORTIZATIONSEQUENCE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_AMORTIZATIONSEQUENCE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_AMORTIZATIONSEQUENCE actions', async () => {
      const expectedActions = [
        {
