...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './terminals-and-pos.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TERMINALSANDPOS_LIST actions', async () => {
    ...
    it('dispatches SEARCH_TERMINALSANDPOS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_TERMINALSANDPOS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TERMINALSANDPOS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TERMINALSANDPOS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TERMINALSANDPOS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TERMINALSANDPOS actions', async () => {
      const expectedActions = [
        {
