...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './particulars-of-outlet.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PARTICULARSOFOUTLET_LIST actions', async () => {
    ...
    it('dispatches SEARCH_PARTICULARSOFOUTLETS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_PARTICULARSOFOUTLET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PARTICULARSOFOUTLET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PARTICULARSOFOUTLET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PARTICULARSOFOUTLET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PARTICULARSOFOUTLET actions', async () => {
      const expectedActions = [
        {
