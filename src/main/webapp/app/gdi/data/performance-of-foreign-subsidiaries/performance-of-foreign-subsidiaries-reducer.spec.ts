...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './performance-of-foreign-subsidiaries.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PERFORMANCEOFFOREIGNSUBSIDIARIES_LIST actions', async () => {
    ...
    it('dispatches SEARCH_PERFORMANCEOFFOREIGNSUBSIDIARIES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_PERFORMANCEOFFOREIGNSUBSIDIARIES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PERFORMANCEOFFOREIGNSUBSIDIARIES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PERFORMANCEOFFOREIGNSUBSIDIARIES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PERFORMANCEOFFOREIGNSUBSIDIARIES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PERFORMANCEOFFOREIGNSUBSIDIARIES actions', async () => {
      const expectedActions = [
        {
