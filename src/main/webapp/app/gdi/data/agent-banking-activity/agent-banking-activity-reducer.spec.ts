...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './agent-banking-activity.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_AGENTBANKINGACTIVITY_LIST actions', async () => {
    ...
    it('dispatches SEARCH_AGENTBANKINGACTIVITIES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_AGENTBANKINGACTIVITY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_AGENTBANKINGACTIVITY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_AGENTBANKINGACTIVITY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_AGENTBANKINGACTIVITY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_AGENTBANKINGACTIVITY actions', async () => {
      const expectedActions = [
        {
