...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_EXCHANGERATE_LIST actions', async () => {
    ...
    it('dispatches SEARCH_EXCHANGERATES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_EXCHANGERATE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_EXCHANGERATE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_EXCHANGERATE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_EXCHANGERATE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_EXCHANGERATE actions', async () => {
      const expectedActions = [
        {
