...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './card-usage-information.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CARDUSAGEINFORMATION_LIST actions', async () => {
    ...
    it('dispatches SEARCH_CARDUSAGEINFORMATIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_CARDUSAGEINFORMATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CARDUSAGEINFORMATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CARDUSAGEINFORMATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CARDUSAGEINFORMATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CARDUSAGEINFORMATION actions', async () => {
      const expectedActions = [
        {
