...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './credit-card-facility.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CREDITCARDFACILITY_LIST actions', async () => {
    ...
    it('dispatches SEARCH_CREDITCARDFACILITIES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_CREDITCARDFACILITY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CREDITCARDFACILITY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CREDITCARDFACILITY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CREDITCARDFACILITY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CREDITCARDFACILITY actions', async () => {
      const expectedActions = [
        {
