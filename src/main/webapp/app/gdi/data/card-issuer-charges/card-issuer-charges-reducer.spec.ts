...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './card-issuer-charges.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CARDISSUERCHARGES_LIST actions', async () => {
    ...
    it('dispatches SEARCH_CARDISSUERCHARGES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_CARDISSUERCHARGES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CARDISSUERCHARGES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CARDISSUERCHARGES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CARDISSUERCHARGES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CARDISSUERCHARGES actions', async () => {
      const expectedActions = [
        {
