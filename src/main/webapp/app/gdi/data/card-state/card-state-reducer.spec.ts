...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CARDSTATE_LIST actions', async () => {
    ...
    it('dispatches SEARCH_CARDSTATES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_CARDSTATE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CARDSTATE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CARDSTATE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CARDSTATE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CARDSTATE actions', async () => {
      const expectedActions = [
        {
