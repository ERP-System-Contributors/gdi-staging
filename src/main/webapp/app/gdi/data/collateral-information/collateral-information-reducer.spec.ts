...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './collateral-information.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_COLLATERALINFORMATION_LIST actions', async () => {
    ...
    it('dispatches SEARCH_COLLATERALINFORMATIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_COLLATERALINFORMATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_COLLATERALINFORMATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_COLLATERALINFORMATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_COLLATERALINFORMATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_COLLATERALINFORMATION actions', async () => {
      const expectedActions = [
        {
