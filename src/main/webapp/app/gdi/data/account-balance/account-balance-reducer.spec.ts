...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ACCOUNTBALANCE_LIST actions', async () => {
    ...
    it('dispatches SEARCH_ACCOUNTBALANCES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_ACCOUNTBALANCE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ACCOUNTBALANCE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ACCOUNTBALANCE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ACCOUNTBALANCE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ACCOUNTBALANCE actions', async () => {
      const expectedActions = [
        {
