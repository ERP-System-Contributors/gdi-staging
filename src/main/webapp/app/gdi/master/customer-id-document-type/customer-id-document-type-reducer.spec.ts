...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CUSTOMERIDDOCUMENTTYPE_LIST actions', async () => {
    ...
    it('dispatches SEARCH_CUSTOMERIDDOCUMENTTYPES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_CUSTOMERIDDOCUMENTTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CUSTOMERIDDOCUMENTTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CUSTOMERIDDOCUMENTTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CUSTOMERIDDOCUMENTTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CUSTOMERIDDOCUMENTTYPE actions', async () => {
      const expectedActions = [
        {
