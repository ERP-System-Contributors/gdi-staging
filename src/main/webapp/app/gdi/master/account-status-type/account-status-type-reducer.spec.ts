...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './account-status-type.reducer';
import { EntityState } from 'app/shared/reducers/reducer.utils';
import { IAccountStatusType, defaultValue } from 'app/shared/model/gdi/account-status-type.model';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ACCOUNTSTATUSTYPE_LIST actions', async () => {
    ...
    it('dispatches SEARCH_ACCOUNTSTATUSTYPES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_ACCOUNTSTATUSTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ACCOUNTSTATUSTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ACCOUNTSTATUSTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ACCOUNTSTATUSTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ACCOUNTSTATUSTYPE actions', async () => {
      const expectedActions = [
        {
