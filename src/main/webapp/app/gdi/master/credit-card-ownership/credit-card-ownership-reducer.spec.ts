...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CREDITCARDOWNERSHIP_LIST actions', async () => {
    ...
    it('dispatches SEARCH_CREDITCARDOWNERSHIPS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_CREDITCARDOWNERSHIP actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CREDITCARDOWNERSHIP actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CREDITCARDOWNERSHIP actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CREDITCARDOWNERSHIP actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CREDITCARDOWNERSHIP actions', async () => {
      const expectedActions = [
        {
