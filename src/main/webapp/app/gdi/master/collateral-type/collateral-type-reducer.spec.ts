...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_COLLATERALTYPE_LIST actions', async () => {
    ...
    it('dispatches SEARCH_COLLATERALTYPES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_COLLATERALTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_COLLATERALTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_COLLATERALTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_COLLATERALTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_COLLATERALTYPE actions', async () => {
      const expectedActions = [
        {
