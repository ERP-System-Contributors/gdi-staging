...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_INSIDERCATEGORYTYPES_LIST actions', async () => {
    ...
    it('dispatches SEARCH_INSIDERCATEGORYTYPES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_INSIDERCATEGORYTYPES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_INSIDERCATEGORYTYPES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_INSIDERCATEGORYTYPES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_INSIDERCATEGORYTYPES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_INSIDERCATEGORYTYPES actions', async () => {
      const expectedActions = [
        {
