...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_OUTLETSTATUS_LIST actions', async () => {
    ...
    it('dispatches SEARCH_OUTLETSTATUSES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_OUTLETSTATUS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_OUTLETSTATUS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_OUTLETSTATUS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_OUTLETSTATUS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_OUTLETSTATUS actions', async () => {
      const expectedActions = [
        {
