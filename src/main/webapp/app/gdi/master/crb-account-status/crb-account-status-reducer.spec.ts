...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CRBACCOUNTSTATUS_LIST actions', async () => {
    ...
    it('dispatches SEARCH_CRBACCOUNTSTATUSES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_CRBACCOUNTSTATUS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CRBACCOUNTSTATUS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CRBACCOUNTSTATUS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CRBACCOUNTSTATUS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CRBACCOUNTSTATUS actions', async () => {
      const expectedActions = [
        {
