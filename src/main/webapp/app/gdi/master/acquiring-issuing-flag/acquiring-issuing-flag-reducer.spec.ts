...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ACQUIRINGISSUINGFLAG_LIST actions', async () => {
    ...
    it('dispatches SEARCH_ACQUIRINGISSUINGFLAGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_ACQUIRINGISSUINGFLAG actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ACQUIRINGISSUINGFLAG actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ACQUIRINGISSUINGFLAG actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ACQUIRINGISSUINGFLAG actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ACQUIRINGISSUINGFLAG actions', async () => {
      const expectedActions = [
        {
