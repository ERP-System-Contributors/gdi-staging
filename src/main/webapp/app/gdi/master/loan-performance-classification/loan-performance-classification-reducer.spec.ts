...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LOANPERFORMANCECLASSIFICATION_LIST actions', async () => {
    ...
    it('dispatches SEARCH_LOANPERFORMANCECLASSIFICATIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_LOANPERFORMANCECLASSIFICATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_LOANPERFORMANCECLASSIFICATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_LOANPERFORMANCECLASSIFICATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_LOANPERFORMANCECLASSIFICATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_LOANPERFORMANCECLASSIFICATION actions', async () => {
      const expectedActions = [
        {
