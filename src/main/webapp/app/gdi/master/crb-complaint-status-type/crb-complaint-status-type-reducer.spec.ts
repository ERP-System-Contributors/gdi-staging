...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './crb-complaint-status-type.reducer';
import { EntityState } from 'app/shared/reducers/reducer.utils';
import { ICrbComplaintStatusType, defaultValue } from 'app/shared/model/gdi/crb-complaint-status-type.model';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CRBCOMPLAINTSTATUSTYPE_LIST actions', async () => {
    ...
    it('dispatches SEARCH_CRBCOMPLAINTSTATUSTYPES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_CRBCOMPLAINTSTATUSTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CRBCOMPLAINTSTATUSTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CRBCOMPLAINTSTATUSTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CRBCOMPLAINTSTATUSTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CRBCOMPLAINTSTATUSTYPE actions', async () => {
      const expectedActions = [
        {
