...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CRBRECORDFILETYPE_LIST actions', async () => {
    ...
    it('dispatches SEARCH_CRBRECORDFILETYPES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_CRBRECORDFILETYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CRBRECORDFILETYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CRBRECORDFILETYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CRBRECORDFILETYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CRBRECORDFILETYPE actions', async () => {
      const expectedActions = [
        {
