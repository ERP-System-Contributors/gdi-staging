...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FXTRANSACTIONCHANNELTYPE_LIST actions', async () => {
    ...
    it('dispatches SEARCH_FXTRANSACTIONCHANNELTYPES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_FXTRANSACTIONCHANNELTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_FXTRANSACTIONCHANNELTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_FXTRANSACTIONCHANNELTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_FXTRANSACTIONCHANNELTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_FXTRANSACTIONCHANNELTYPE actions', async () => {
      const expectedActions = [
        {
