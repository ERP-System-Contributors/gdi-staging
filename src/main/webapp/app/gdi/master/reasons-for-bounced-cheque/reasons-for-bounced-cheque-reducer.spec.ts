...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_REASONSFORBOUNCEDCHEQUE_LIST actions', async () => {
    ...
    it('dispatches SEARCH_REASONSFORBOUNCEDCHEQUES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_REASONSFORBOUNCEDCHEQUE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_REASONSFORBOUNCEDCHEQUE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_REASONSFORBOUNCEDCHEQUE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_REASONSFORBOUNCEDCHEQUE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_REASONSFORBOUNCEDCHEQUE actions', async () => {
      const expectedActions = [
        {
