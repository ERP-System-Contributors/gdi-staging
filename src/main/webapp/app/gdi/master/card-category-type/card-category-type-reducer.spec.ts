...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './card-category-type.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CARDCATEGORYTYPE_LIST actions', async () => {
    ...
    it('dispatches SEARCH_CARDCATEGORYTYPES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_CARDCATEGORYTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CARDCATEGORYTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CARDCATEGORYTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CARDCATEGORYTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CARDCATEGORYTYPE actions', async () => {
      const expectedActions = [
        {
