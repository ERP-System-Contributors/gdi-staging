...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './security-type.reducer';
import { EntityState } from 'app/shared/reducers/reducer.utils';
import { ISecurityType, defaultValue } from 'app/shared/model/gdi/security-type.model';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SECURITYTYPE_LIST actions', async () => {
    ...
    it('dispatches SEARCH_SECURITYTYPES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_SECURITYTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SECURITYTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SECURITYTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SECURITYTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SECURITYTYPE actions', async () => {
      const expectedActions = [
        {
