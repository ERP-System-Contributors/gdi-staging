...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_INSTITUTIONCODE_LIST actions', async () => {
    ...
    it('dispatches SEARCH_INSTITUTIONCODES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_INSTITUTIONCODE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_INSTITUTIONCODE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_INSTITUTIONCODE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_INSTITUTIONCODE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_INSTITUTIONCODE actions', async () => {
      const expectedActions = [
        {
