...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CARDTYPES_LIST actions', async () => {
    ...
    it('dispatches SEARCH_CARDTYPES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_CARDTYPES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CARDTYPES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CARDTYPES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CARDTYPES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CARDTYPES actions', async () => {
      const expectedActions = [
        {
