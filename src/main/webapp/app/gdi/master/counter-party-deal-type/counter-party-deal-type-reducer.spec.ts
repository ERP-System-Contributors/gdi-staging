...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_COUNTERPARTYDEALTYPE_LIST actions', async () => {
    ...
    it('dispatches SEARCH_COUNTERPARTYDEALTYPES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_COUNTERPARTYDEALTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_COUNTERPARTYDEALTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_COUNTERPARTYDEALTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_COUNTERPARTYDEALTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_COUNTERPARTYDEALTYPE actions', async () => {
      const expectedActions = [
        {
