...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_KENYANCURRENCYDENOMINATION_LIST actions', async () => {
    ...
    it('dispatches SEARCH_KENYANCURRENCYDENOMINATIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_KENYANCURRENCYDENOMINATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_KENYANCURRENCYDENOMINATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_KENYANCURRENCYDENOMINATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_KENYANCURRENCYDENOMINATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_KENYANCURRENCYDENOMINATION actions', async () => {
      const expectedActions = [
        {
