...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DERIVATIVEUNDERLYINGASSET_LIST actions', async () => {
    ...
    it('dispatches SEARCH_DERIVATIVEUNDERLYINGASSETS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_DERIVATIVEUNDERLYINGASSET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_DERIVATIVEUNDERLYINGASSET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_DERIVATIVEUNDERLYINGASSET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_DERIVATIVEUNDERLYINGASSET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_DERIVATIVEUNDERLYINGASSET actions', async () => {
      const expectedActions = [
        {
