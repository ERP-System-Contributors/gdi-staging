...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CONTRACTSTATUS_LIST actions', async () => {
    ...
    it('dispatches SEARCH_CONTRACTSTATUSES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_CONTRACTSTATUS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CONTRACTSTATUS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CONTRACTSTATUS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CONTRACTSTATUS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CONTRACTSTATUS actions', async () => {
      const expectedActions = [
        {
