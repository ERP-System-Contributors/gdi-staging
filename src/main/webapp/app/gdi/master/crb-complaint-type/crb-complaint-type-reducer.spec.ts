...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CRBCOMPLAINTTYPE_LIST actions', async () => {
    ...
    it('dispatches SEARCH_CRBCOMPLAINTTYPES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_CRBCOMPLAINTTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CRBCOMPLAINTTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CRBCOMPLAINTTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CRBCOMPLAINTTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CRBCOMPLAINTTYPE actions', async () => {
      const expectedActions = [
        {
