...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SHAREHOLDINGFLAG_LIST actions', async () => {
    ...
    it('dispatches SEARCH_SHAREHOLDINGFLAGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_SHAREHOLDINGFLAG actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SHAREHOLDINGFLAG actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SHAREHOLDINGFLAG actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SHAREHOLDINGFLAG actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SHAREHOLDINGFLAG actions', async () => {
      const expectedActions = [
        {
