...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CRBNATUREOFINFORMATION_LIST actions', async () => {
    ...
    it('dispatches SEARCH_CRBNATUREOFINFORMATIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_CRBNATUREOFINFORMATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CRBNATUREOFINFORMATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CRBNATUREOFINFORMATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CRBNATUREOFINFORMATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CRBNATUREOFINFORMATION actions', async () => {
      const expectedActions = [
        {
