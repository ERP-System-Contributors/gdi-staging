...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './crb-submitting-institution-category.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CRBSUBMITTINGINSTITUTIONCATEGORY_LIST actions', async () => {
    ...
    it('dispatches SEARCH_CRBSUBMITTINGINSTITUTIONCATEGORIES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_CRBSUBMITTINGINSTITUTIONCATEGORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CRBSUBMITTINGINSTITUTIONCATEGORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CRBSUBMITTINGINSTITUTIONCATEGORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CRBSUBMITTINGINSTITUTIONCATEGORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CRBSUBMITTINGINSTITUTIONCATEGORY actions', async () => {
      const expectedActions = [
        {
