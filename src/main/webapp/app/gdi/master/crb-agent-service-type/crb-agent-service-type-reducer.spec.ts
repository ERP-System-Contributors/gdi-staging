...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CRBAGENTSERVICETYPE_LIST actions', async () => {
    ...
    it('dispatches SEARCH_CRBAGENTSERVICETYPES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_CRBAGENTSERVICETYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CRBAGENTSERVICETYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CRBAGENTSERVICETYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CRBAGENTSERVICETYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CRBAGENTSERVICETYPE actions', async () => {
      const expectedActions = [
        {
