...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ISOCURRENCYCODE_LIST actions', async () => {
    ...
    it('dispatches SEARCH_ISOCURRENCYCODES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_ISOCURRENCYCODE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ISOCURRENCYCODE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ISOCURRENCYCODE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ISOCURRENCYCODE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ISOCURRENCYCODE actions', async () => {
      const expectedActions = [
        {
