...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FXRECEIPTPURPOSETYPE_LIST actions', async () => {
    ...
    it('dispatches SEARCH_FXRECEIPTPURPOSETYPES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_FXRECEIPTPURPOSETYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_FXRECEIPTPURPOSETYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_FXRECEIPTPURPOSETYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_FXRECEIPTPURPOSETYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_FXRECEIPTPURPOSETYPE actions', async () => {
      const expectedActions = [
        {
