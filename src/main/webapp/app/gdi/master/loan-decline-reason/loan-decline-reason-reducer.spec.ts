...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LOANDECLINEREASON_LIST actions', async () => {
    ...
    it('dispatches SEARCH_LOANDECLINEREASONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_LOANDECLINEREASON actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_LOANDECLINEREASON actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_LOANDECLINEREASON actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_LOANDECLINEREASON actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_LOANDECLINEREASON actions', async () => {
      const expectedActions = [
        {
