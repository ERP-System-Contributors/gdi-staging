...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_STAFFCURRENTEMPLOYMENTSTATUS_LIST actions', async () => {
    ...
    it('dispatches SEARCH_STAFFCURRENTEMPLOYMENTSTATUSES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_STAFFCURRENTEMPLOYMENTSTATUS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_STAFFCURRENTEMPLOYMENTSTATUS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_STAFFCURRENTEMPLOYMENTSTATUS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_STAFFCURRENTEMPLOYMENTSTATUS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_STAFFCURRENTEMPLOYMENTSTATUS actions', async () => {
      const expectedActions = [
        {
