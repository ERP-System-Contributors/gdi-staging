...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MERCHANTTYPE_LIST actions', async () => {
    ...
    it('dispatches SEARCH_MERCHANTTYPES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_MERCHANTTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_MERCHANTTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_MERCHANTTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_MERCHANTTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_MERCHANTTYPE actions', async () => {
      const expectedActions = [
        {
