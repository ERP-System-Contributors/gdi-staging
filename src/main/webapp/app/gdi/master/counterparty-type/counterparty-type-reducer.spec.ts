...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './counterparty-type.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_COUNTERPARTYTYPE_LIST actions', async () => {
    ...
    it('dispatches SEARCH_COUNTERPARTYTYPES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_COUNTERPARTYTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_COUNTERPARTYTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_COUNTERPARTYTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_COUNTERPARTYTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_COUNTERPARTYTYPE actions', async () => {
      const expectedActions = [
        {
