...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './department-type.reducer';
import { EntityState } from 'app/shared/reducers/reducer.utils';
import { IDepartmentType, defaultValue } from 'app/shared/model/gdi/department-type.model';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DEPARTMENTTYPE_LIST actions', async () => {
    ...
    it('dispatches SEARCH_DEPARTMENTTYPES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_DEPARTMENTTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_DEPARTMENTTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_DEPARTMENTTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_DEPARTMENTTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_DEPARTMENTTYPE actions', async () => {
      const expectedActions = [
        {
