...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_INTERESTCALCMETHOD_LIST actions', async () => {
    ...
    it('dispatches SEARCH_INTERESTCALCMETHODS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_INTERESTCALCMETHOD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_INTERESTCALCMETHOD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_INTERESTCALCMETHOD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_INTERESTCALCMETHOD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_INTERESTCALCMETHOD actions', async () => {
      const expectedActions = [
        {
