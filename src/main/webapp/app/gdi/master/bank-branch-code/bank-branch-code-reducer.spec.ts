...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BANKBRANCHCODE_LIST actions', async () => {
    ...
    it('dispatches SEARCH_BANKBRANCHCODES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_BANKBRANCHCODE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_BANKBRANCHCODE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_BANKBRANCHCODE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_BANKBRANCHCODE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_BANKBRANCHCODE actions', async () => {
      const expectedActions = [
        {
