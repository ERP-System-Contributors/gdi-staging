...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ACADEMICQUALIFICATION_LIST actions', async () => {
    ...
    it('dispatches SEARCH_ACADEMICQUALIFICATIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_ACADEMICQUALIFICATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ACADEMICQUALIFICATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ACADEMICQUALIFICATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ACADEMICQUALIFICATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ACADEMICQUALIFICATION actions', async () => {
      const expectedActions = [
        {
