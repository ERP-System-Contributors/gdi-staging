...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ANTICIPATEDMATURITYPERIOOD_LIST actions', async () => {
    ...
    it('dispatches SEARCH_ANTICIPATEDMATURITYPERIOODS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_ANTICIPATEDMATURITYPERIOOD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ANTICIPATEDMATURITYPERIOOD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ANTICIPATEDMATURITYPERIOOD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ANTICIPATEDMATURITYPERIOOD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ANTICIPATEDMATURITYPERIOOD actions', async () => {
      const expectedActions = [
        {
