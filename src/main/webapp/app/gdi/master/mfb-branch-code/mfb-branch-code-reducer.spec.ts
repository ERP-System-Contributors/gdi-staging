...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MFBBRANCHCODE_LIST actions', async () => {
    ...
    it('dispatches SEARCH_MFBBRANCHCODES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_MFBBRANCHCODE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_MFBBRANCHCODE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_MFBBRANCHCODE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_MFBBRANCHCODE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_MFBBRANCHCODE actions', async () => {
      const expectedActions = [
        {
