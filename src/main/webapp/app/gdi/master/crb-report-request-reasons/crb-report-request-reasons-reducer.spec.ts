...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CRBREPORTREQUESTREASONS_LIST actions', async () => {
    ...
    it('dispatches SEARCH_CRBREPORTREQUESTREASONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_CRBREPORTREQUESTREASONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CRBREPORTREQUESTREASONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CRBREPORTREQUESTREASONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CRBREPORTREQUESTREASONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CRBREPORTREQUESTREASONS actions', async () => {
      const expectedActions = [
        {
