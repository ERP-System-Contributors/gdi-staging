...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BOUNCEDCHEQUECATEGORIES_LIST actions', async () => {
    ...
    it('dispatches SEARCH_BOUNCEDCHEQUECATEGORIES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_BOUNCEDCHEQUECATEGORIES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_BOUNCEDCHEQUECATEGORIES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_BOUNCEDCHEQUECATEGORIES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_BOUNCEDCHEQUECATEGORIES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_BOUNCEDCHEQUECATEGORIES actions', async () => {
      const expectedActions = [
        {
