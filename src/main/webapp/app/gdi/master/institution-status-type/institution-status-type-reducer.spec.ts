...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_INSTITUTIONSTATUSTYPE_LIST actions', async () => {
    ...
    it('dispatches SEARCH_INSTITUTIONSTATUSTYPES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_INSTITUTIONSTATUSTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_INSTITUTIONSTATUSTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_INSTITUTIONSTATUSTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_INSTITUTIONSTATUSTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_INSTITUTIONSTATUSTYPE actions', async () => {
      const expectedActions = [
        {
