...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CARDBRANDTYPE_LIST actions', async () => {
    ...
    it('dispatches SEARCH_CARDBRANDTYPES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_CARDBRANDTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CARDBRANDTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CARDBRANDTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CARDBRANDTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CARDBRANDTYPE actions', async () => {
      const expectedActions = [
        {
