...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FXCUSTOMERTYPE_LIST actions', async () => {
    ...
    it('dispatches SEARCH_FXCUSTOMERTYPES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_FXCUSTOMERTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_FXCUSTOMERTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_FXCUSTOMERTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_FXCUSTOMERTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_FXCUSTOMERTYPE actions', async () => {
      const expectedActions = [
        {
