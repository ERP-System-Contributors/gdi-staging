...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_AGRICULTURALENTERPRISEACTIVITYTYPE_LIST actions', async () => {
    ...
    it('dispatches SEARCH_AGRICULTURALENTERPRISEACTIVITYTYPES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_AGRICULTURALENTERPRISEACTIVITYTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_AGRICULTURALENTERPRISEACTIVITYTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_AGRICULTURALENTERPRISEACTIVITYTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_AGRICULTURALENTERPRISEACTIVITYTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_AGRICULTURALENTERPRISEACTIVITYTYPE actions', async () => {
      const expectedActions = [
        {
