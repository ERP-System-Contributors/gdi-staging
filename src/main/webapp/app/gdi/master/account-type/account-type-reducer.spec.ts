...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ACCOUNTTYPE_LIST actions', async () => {
    ...
    it('dispatches SEARCH_ACCOUNTTYPES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_ACCOUNTTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ACCOUNTTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ACCOUNTTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ACCOUNTTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ACCOUNTTYPE actions', async () => {
      const expectedActions = [
        {
