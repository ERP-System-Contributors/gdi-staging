...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './loan-restructure-item.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LOANRESTRUCTUREITEM_LIST actions', async () => {
    ...
    it('dispatches SEARCH_LOANRESTRUCTUREITEMS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_LOANRESTRUCTUREITEM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_LOANRESTRUCTUREITEM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_LOANRESTRUCTUREITEM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_LOANRESTRUCTUREITEM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_LOANRESTRUCTUREITEM actions', async () => {
      const expectedActions = [
        {
