...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BANKTRANSACTIONTYPE_LIST actions', async () => {
    ...
    it('dispatches SEARCH_BANKTRANSACTIONTYPES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_BANKTRANSACTIONTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_BANKTRANSACTIONTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_BANKTRANSACTIONTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_BANKTRANSACTIONTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_BANKTRANSACTIONTYPE actions', async () => {
      const expectedActions = [
        {
