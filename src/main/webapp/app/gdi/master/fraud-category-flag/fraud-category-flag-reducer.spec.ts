...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FRAUDCATEGORYFLAG_LIST actions', async () => {
    ...
    it('dispatches SEARCH_FRAUDCATEGORYFLAGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_FRAUDCATEGORYFLAG actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_FRAUDCATEGORYFLAG actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_FRAUDCATEGORYFLAG actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_FRAUDCATEGORYFLAG actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_FRAUDCATEGORYFLAG actions', async () => {
      const expectedActions = [
        {
