...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_INTERBANKSECTORCODE_LIST actions', async () => {
    ...
    it('dispatches SEARCH_INTERBANKSECTORCODES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_INTERBANKSECTORCODE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_INTERBANKSECTORCODE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_INTERBANKSECTORCODE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_INTERBANKSECTORCODE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_INTERBANKSECTORCODE actions', async () => {
      const expectedActions = [
        {
