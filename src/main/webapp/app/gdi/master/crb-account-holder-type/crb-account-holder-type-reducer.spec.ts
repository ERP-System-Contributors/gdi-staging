...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CRBACCOUNTHOLDERTYPE_LIST actions', async () => {
    ...
    it('dispatches SEARCH_CRBACCOUNTHOLDERTYPES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_CRBACCOUNTHOLDERTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CRBACCOUNTHOLDERTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CRBACCOUNTHOLDERTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CRBACCOUNTHOLDERTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CRBACCOUNTHOLDERTYPE actions', async () => {
      const expectedActions = [
        {
