...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CRBAMOUNTCATEGORYBAND_LIST actions', async () => {
    ...
    it('dispatches SEARCH_CRBAMOUNTCATEGORYBANDS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_CRBAMOUNTCATEGORYBAND actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CRBAMOUNTCATEGORYBAND actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CRBAMOUNTCATEGORYBAND actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CRBAMOUNTCATEGORYBAND actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CRBAMOUNTCATEGORYBAND actions', async () => {
      const expectedActions = [
        {
