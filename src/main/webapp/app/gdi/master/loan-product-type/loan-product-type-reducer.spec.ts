...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LOANPRODUCTTYPE_LIST actions', async () => {
    ...
    it('dispatches SEARCH_LOANPRODUCTTYPES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_LOANPRODUCTTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_LOANPRODUCTTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_LOANPRODUCTTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_LOANPRODUCTTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_LOANPRODUCTTYPE actions', async () => {
      const expectedActions = [
        {
