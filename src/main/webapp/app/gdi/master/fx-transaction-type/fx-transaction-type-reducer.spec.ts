...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './fx-transaction-type.reducer';
import { EntityState } from 'app/shared/reducers/reducer.utils';
import { IFxTransactionType, defaultValue } from 'app/shared/model/gdi/fx-transaction-type.model';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FXTRANSACTIONTYPE_LIST actions', async () => {
    ...
    it('dispatches SEARCH_FXTRANSACTIONTYPES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_FXTRANSACTIONTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_FXTRANSACTIONTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_FXTRANSACTIONTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_FXTRANSACTIONTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_FXTRANSACTIONTYPE actions', async () => {
      const expectedActions = [
        {
