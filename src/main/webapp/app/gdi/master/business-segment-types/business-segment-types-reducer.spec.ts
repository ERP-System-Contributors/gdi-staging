...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BUSINESSSEGMENTTYPES_LIST actions', async () => {
    ...
    it('dispatches SEARCH_BUSINESSSEGMENTTYPES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_BUSINESSSEGMENTTYPES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_BUSINESSSEGMENTTYPES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_BUSINESSSEGMENTTYPES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_BUSINESSSEGMENTTYPES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_BUSINESSSEGMENTTYPES actions', async () => {
      const expectedActions = [
        {
