...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './crb-source-of-information-type.reducer';
import { EntityState } from 'app/shared/reducers/reducer.utils';
import { ICrbSourceOfInformationType, defaultValue } from 'app/shared/model/gdi/crb-source-of-information-type.model';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CRBSOURCEOFINFORMATIONTYPE_LIST actions', async () => {
    ...
    it('dispatches SEARCH_CRBSOURCEOFINFORMATIONTYPES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_CRBSOURCEOFINFORMATIONTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CRBSOURCEOFINFORMATIONTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CRBSOURCEOFINFORMATIONTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CRBSOURCEOFINFORMATIONTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CRBSOURCEOFINFORMATIONTYPE actions', async () => {
      const expectedActions = [
        {
