...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CURRENCYAUTHENTICITYFLAG_LIST actions', async () => {
    ...
    it('dispatches SEARCH_CURRENCYAUTHENTICITYFLAGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_CURRENCYAUTHENTICITYFLAG actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CURRENCYAUTHENTICITYFLAG actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CURRENCYAUTHENTICITYFLAG actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CURRENCYAUTHENTICITYFLAG actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CURRENCYAUTHENTICITYFLAG actions', async () => {
      const expectedActions = [
        {
