...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FINANCIALDERIVATIVETYPECODE_LIST actions', async () => {
    ...
    it('dispatches SEARCH_FINANCIALDERIVATIVETYPECODES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_FINANCIALDERIVATIVETYPECODE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_FINANCIALDERIVATIVETYPECODE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_FINANCIALDERIVATIVETYPECODE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_FINANCIALDERIVATIVETYPECODE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_FINANCIALDERIVATIVETYPECODE actions', async () => {
      const expectedActions = [
        {
