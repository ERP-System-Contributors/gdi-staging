...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CRBGLCODE_LIST actions', async () => {
    ...
    it('dispatches SEARCH_CRBGLCODES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_CRBGLCODE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CRBGLCODE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CRBGLCODE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CRBGLCODE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CRBGLCODE actions', async () => {
      const expectedActions = [
        {
