...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './crb-credit-application-status.reducer';
import { EntityState } from 'app/shared/reducers/reducer.utils';
import { ICrbCreditApplicationStatus, defaultValue } from 'app/shared/model/gdi/crb-credit-application-status.model';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CRBCREDITAPPLICATIONSTATUS_LIST actions', async () => {
    ...
    it('dispatches SEARCH_CRBCREDITAPPLICATIONSTATUSES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_CRBCREDITAPPLICATIONSTATUS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CRBCREDITAPPLICATIONSTATUS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CRBCREDITAPPLICATIONSTATUS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CRBCREDITAPPLICATIONSTATUS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CRBCREDITAPPLICATIONSTATUS actions', async () => {
      const expectedActions = [
        {
