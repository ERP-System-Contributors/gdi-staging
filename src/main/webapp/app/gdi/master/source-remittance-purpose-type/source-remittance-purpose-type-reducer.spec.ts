...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './source-remittance-purpose-type.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SOURCEREMITTANCEPURPOSETYPE_LIST actions', async () => {
    ...
    it('dispatches SEARCH_SOURCEREMITTANCEPURPOSETYPES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_SOURCEREMITTANCEPURPOSETYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SOURCEREMITTANCEPURPOSETYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SOURCEREMITTANCEPURPOSETYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SOURCEREMITTANCEPURPOSETYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SOURCEREMITTANCEPURPOSETYPE actions', async () => {
      const expectedActions = [
        {
